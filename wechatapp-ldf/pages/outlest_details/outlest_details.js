...
Page({
  ...
  bindm1: function(e) {
    ...
    if (type == "image") {
      ...
      var videosUrl_ = new Array();
      that.data.videosUrl.forEach(function(obj, index) {
        if (obj.path != that.data.path) {
          videosUrl_.push(obj);
        }
      });
      that.setData({ videosUrl: videosUrl_ });
    }
    this.setData({
      actionSheetHidden: !this.data.actionSheetHidden
    });
  },
  closeDeleteMenu: function(e) {
    this.setData({
      actionSheetHidden: !this.data.actionSheetHidden
    });
  }
...
function viewWebSiteInfo(that) {
  ...
  var webSiteId = that.data.webSiteId;
  var url =
    getApp().globalData.mainUrl +
    "WX_MiniApps_WebSite_GetWebSiteDetail.ashx?1=1";
  wx.request({
    url: url,
    data: {
      Token: Token,
...
function viewSignInfo(that) {
  ...
  var url =
    getApp().globalData.mainUrl +
    "WX_MiniApps_WebSite_GetWebSite_NotFinishLoop.ashx?1=1";
  wx.request({
    url: url,
    data: {
      Token: Token,
...
function signIn_(that) {
  ...
  var webSiteId = that.data.webSiteId;
  var url =
    getApp().globalData.mainUrl + "WX_MiniApps_WebSite_LoopSignIn.ashx?1=1";
  wx.request({
    url: url,
    data: {
      Token: Token,
...
function signOut_(that) {
  ...
  var webSiteId = that.data.webSiteId;
  var url =
    getApp().globalData.mainUrl + "WX_MiniApps_WebSite_LoopSignOut.ashx?1=1";
  wx.request({
    url: url,
    data: {
      Token: Token,
...
function uploadSignPics(that) {
  ...
  var webSiteId = that.data.webSiteId;
  var url =
    getApp().globalData.mainUrl + "WX_MiniApps_WebSite_LoopUploadImg.ashx?1=1";
  url =
    url +
    "&Token=" +
    Token +
...
function uploadSignVideos(that) {
  ...
  var url =
    getApp().globalData.mainUrl +
    "WX_MiniApps_WebSite_LoopUploadVideo.ashx?1=1";
  url =
    url +
    "&Token=" +
    Token +
